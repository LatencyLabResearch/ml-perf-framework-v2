/**
 * Exp_B_22 — Mixed Load, All Endpoints, Combined
...
export default function () {
  ...
  if (roll < 0.30) {
    ...
    const headers = { ...buildHeaders('EXP-22'), 'x-endpoint-group': 'lightweight' };
    ...
    const headers = { ...buildHeaders('EXP-22'), 'x-endpoint-group': 'medium' };
    ...
    const headers = { ...buildHeaders('EXP-22'), 'x-endpoint-group': 'heavy' };
