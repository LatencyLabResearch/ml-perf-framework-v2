/**
 * Exp_B_21 — Burst Load, All Endpoints, Combined
...
export default function () {
  ...
  if (roll < 0.30) {
    ...
    const headers = { ...buildHeaders('Exp-B-21'), 'x-endpoint-group': 'lightweight' };
    ...
    const headers = { ...buildHeaders('Exp-B-21'), 'x-endpoint-group': 'medium' };
    ...
    const headers = { ...buildHeaders('Exp-21'), 'x-endpoint-group': 'medium' };
    ...
    const headers = { ...buildHeaders('Exp-21'), 'x-endpoint-group': 'heavy' };
