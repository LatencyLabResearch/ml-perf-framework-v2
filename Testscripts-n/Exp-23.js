/**
 * Exp_B_23 — Mixed Stress Load, All Endpoints, Combined
...
export default function () {
  ...
  if (roll < 0.30) {
    ...
    const headers = { ...buildHeaders('EXP-23'), 'x-endpoint-group': 'lightweight' };
    ...
    const headers = { ...buildHeaders('EXP-23'), 'x-endpoint-group': 'medium' };
    ...
    const headers = { ...buildHeaders('EXP-23'), 'x-endpoint-group': 'heavy' };
