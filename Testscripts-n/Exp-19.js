/**
 * Exp_B_19 — Steady Load, All Endpoints, Combined
 * Users  : 100 (constant)
 * Duration: 10 minutes
 * Pattern : Steady
...
export default function () {
  ...
  if (roll < 0.30) {
    ...
    const headers = { ...buildHeaders('Exp-B-19'), 'x-endpoint-group': 'lightweight' };
    ...
    // --- M1: POST /api/orders  (15 %) ---
    const headers = { ...buildHeaders('Exp-B-19'), 'x-endpoint-group': 'medium' };
    ...
    const headers = { ...buildHeaders('Exp-19'), 'x-endpoint-group': 'medium' };
    ...
    // --- H1: GET /api/reports/user-orders  (5 %) ---
    const headers = { ...buildHeaders('Exp-19'), 'x-endpoint-group': 'heavy' };
