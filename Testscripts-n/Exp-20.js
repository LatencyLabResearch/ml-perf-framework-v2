/**
 * Exp_B_20 — Peak Load, All Endpoints, Combined
 * Users  : 100 → 500
 * Duration: 10 minutes
 * Pattern : Peak
...
export default function () {
  ...
  if (roll < 0.30) {
    ...
    const headers = { ...buildHeaders('Exp-B-20'), 'x-endpoint-group': 'lightweight' };
    ...
    const headers = { ...buildHeaders('Exp-20'), 'x-endpoint-group': 'medium' };
    ...
    const headers = { ...buildHeaders('Exp-B-20'), 'x-endpoint-group': 'heavy' };
    ...
    const headers = { ...buildHeaders('Exp-20'), 'x-endpoint-group': 'heavy' };
